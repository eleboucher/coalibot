...
func Dtc(option string, event *Struct.Message) bool {
	...
	params := slack.PostMessageParameters{ThreadTimestamp: event.Timestamp, IconURL: "https://danstonchat.com/icache/size/300c300/themes/danstonchat2016/images/logo-og.png", Username: "Dans Ton Chat"}
