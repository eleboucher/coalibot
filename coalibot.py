...
def dobby(channel, user):
	if user in master :
		message = "COUCOU!"
	else:
		message = "Toi pas maitre de Dobby"
	sc.api_call(
            "chat.postMessage",
            channel= channel,
            icon_url= "http://cdn.playbuzz.com/cdn/66f922e7-af02-4e0c-9005-99f36c6a556b/780b5a18-483a-495a-9209-d9dac17c53c7_560_420.jpg",
            username = "Dobby",
            text= message
        )
