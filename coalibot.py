        ...
        attachments = [
                {
                    ...
                    'fields': [
                        ...
                        {
                            "title": data[1]['name'],
                            "value": str(data[1]['score']) + "("+ str(int(data[0]['score']) - int(data[1]['score']))  +")",
                            "short": True
                        },
                        {
                            "title": data[2]['name'],
                            "value": str(data[1]['score']) + "("+ str(int(data[0]['score']) - int(data[2]['score']))  +")",
                            "short": True
                        },
                        {
                            "title": data[3]['name'],
                            "value": str(data[1]['score']) + "("+ str(int(data[0]['score']) - int(data[3]['score']))  +")",
                            "short": True
                        }
                    ],
