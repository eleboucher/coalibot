...
/*   Updated: 2018/04/24 18:33:11 by elebouch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const roulette = async (channel, user) => {
  ...
  if (russiantab[0] === 1) {
    postMessage(`<@${username}>: Bang (${6 - russiantab.length + 1} / 6 )`, channel)
    russiantab = []
  } else {
    postMessage(`<@${username}>: click (${6 - russiantab.length + 1} / 6 )`, channel)
    russiantab.shift()
  }
}
