        ...
        attachments = [
                {
                    ...
                    'fields': [
                        ...
                        {
                            "title": data[1]['name'],
                            "value": data[1]['score'] + "("+ int(data[0]['score']) - int(data[1]['score'])  +")",
                            "short": True
                        },
                        {
                            "title": data[2]['name'],
                            "value": data[2]['score'] + "("+ int(data[0]['score']) - int(data[1]['score'])  +")",
                            "short": True
                        },
                        {
                            "title": data[3]['name'],
                            "value": data[3]['score'] + "("+ int(data[0]['score']) - int(data[1]['score'])  +")",
                            "short": True
                        }
                    ],
